...
use App\Repository\Production\WorkOrderVarnishProductionDetailRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: WorkOrderVarnishProductionDetailRepository::class)]
#[ORM\Table(name: 'production_work_order_varnish_production_detail')]
class WorkOrderVarnishProductionDetail extends ProductionDetail
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'workOrderVarnishProductionDetails')]
