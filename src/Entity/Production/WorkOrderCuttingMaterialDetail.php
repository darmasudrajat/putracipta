...
use App\Repository\Production\WorkOrderCuttingMaterialDetailRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: WorkOrderCuttingMaterialDetailRepository::class)]
#[ORM\Table(name: 'production_work_order_cutting_material_detail')]
class WorkOrderCuttingMaterialDetail extends ProductionDetail
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'workOrderCuttingMaterialDetails')]
    ...
    #[ORM\Column]
    private ?int $cuttingQuantityRim = 0;
    ...
    public function getCuttingQuantityRim(): ?int
    {
        return $this->cuttingQuantityRim;
    }

    public function setCuttingQuantityRim(int $cuttingQuantityRim): self
    {
        $this->cuttingQuantityRim = $cuttingQuantityRim;
