    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => [ 'code', 'variant', 'version', 'name', 'date', 'customer:company'],
                'field_label_list' => [
                    'code' => 'Code',
                    'variant' => '',
                    'version' => '',
                ...
                'field_operators_list' => [
                    ...
                    'date' => [FilterBetween::class, FilterNotBetween::class],
                ],
                'field_value_options_list' => [
                    'date' => ['attr' => ['data-controller' => 'flatpickr-element']],
                ],
            ])
            ->add('sort', SortType::class, [
                'field_names' => ['name', 'code', 'variant', 'version', 'customer:company', 'date'],
                'field_label_list' => [
                    'code' => '',
                    'variant' => '',
                    'version' => 'Code',
