    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('filter', FilterType::class, [
                'field_names' => ['purchaseOrderPaperHeader:codeNumberOrdinal', 'purchaseOrderPaperHeader:codeNumberMonth', 'purchaseOrderPaperHeader:codeNumberYear', 'purchaseOrderPaperHeader:transactionDate', 'purchaseOrderPaperHeader:referenceNumber', 'name', 'purchaseOrderPaperHeader:note', 'purchaseOrderPaperHeader:transactionStatus'],
                'field_label_list' => [
                ...
                'field_operators_list' => [
                    ...
                    'purchaseOrderPaperHeader:referenceNumber' => [FilterContain::class, FilterNotContain::class],
            ...
            ->add('sort', SortType::class, [
                'field_names' => ['purchaseOrderPaperHeader:transactionDate', 'name', 'purchaseOrderPaperHeader:referenceNumber', 'purchaseOrderPaperHeader:note', 'purchaseOrderPaperHeader:transactionStatus', 'purchaseOrderPaperHeader:codeNumberYear', 'purchaseOrderPaperHeader:codeNumberMonth', 'purchaseOrderPaperHeader:codeNumberOrdinal'],
                'field_label_list' => [
                ...
                'field_operators_list' => [
                    ...
                    'purchaseOrderPaperHeader:referenceNumber' => [SortAscending::class, SortDescending::class],
