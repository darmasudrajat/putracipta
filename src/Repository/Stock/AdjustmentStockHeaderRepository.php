...
class AdjustmentStockHeaderRepository extends ServiceEntityRepository
{
    ...
    {
        $dql = 'SELECT e FROM ' . AdjustmentStockHeader::class . ' e WHERE e.codeNumberMonth = :codeNumberMonth AND e.codeNumberYear = :codeNumberYear ORDER BY e.codeNumberOrdinal DESC';
